...
Defined in: [packages/db/src/strategies/types.ts:42](https://github.com/quanphm/db/blob/main/packages/db/src/strategies/types.ts#L42)
...
Defined in: [packages/db/src/strategies/types.ts:43](https://github.com/quanphm/db/blob/main/packages/db/src/strategies/types.ts#L43)
