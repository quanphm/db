...
Defined in: [packages/db/src/types.ts:723](https://github.com/quanphm/db/blob/main/packages/db/src/types.ts#L723)
...
Defined in: [packages/db/src/types.ts:725](https://github.com/quanphm/db/blob/main/packages/db/src/types.ts#L725)
